...
| Spatial (V2) | ray cast edge cases, shapefile record layouts (point vs polyline), station bridge, 路線 identity and its sampled municipality join, バス停 bridge, mesh classification, lineage successors | no |
